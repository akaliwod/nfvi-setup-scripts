...
echo -e "\nStep 3: Delete 'esc-demo' tenant\n"
proj_id=`openstack project list | grep "\besc-demo\b" | awk '{ print $2 }'`
if [ -z $proj_id ]; then
	echo -e "Warning: no project 'esc-demo' found\n"
else
	echo -e "Project 'esc-demo' ($proj_id) deleted\n"
	openstack project delete $proj_id
fi
